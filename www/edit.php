...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="backend/handlers/edit.php?id=<?= $edit_user_id ?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" id="simpleinput" class="form-control" value="<?= $edit_user['name'] ?>">
                                </div>

                                <!-- company -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Место работы</label>
                                    <input name="job_company" type="text" id="simpleinput" class="form-control" value="<?= $edit_user['job_company'] ?>">
                                </div>

                                <!-- position -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Должность</label>
                                    <input name="position" type="text" id="simpleinput" class="form-control" value="<?= $edit_user['position'] ?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input name="phone" type="text" id="simpleinput" class="form-control" value="<?= $edit_user['phone'] ?>">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input name="job_address" type="text" id="simpleinput" class="form-control" value="<?= $edit_user['job_address'] ?>">
                                </div>
