...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
            ...
            <?php if (existFlashMessage('error_create_user')): ?>
            <div class="col-xl-6 ml-auto mr-auto">
                <div class="alert alert-danger text-dark" role="alert">
                    <?= getFlashMessage('error_create_user') ?>
                </div>
            </div>
            <?php endif; deleteFlashMessage('error_create_user'); ?>
            <?php if (existFlashMessage('error_upload_image')): ?>
                <div class="col-xl-6 ml-auto mr-auto">
                    <div class="alert alert-danger text-dark" role="alert">
                        <?= getFlashMessage('error_upload_image') ?>
                    </div>
                </div>
            <?php endif; deleteFlashMessage('error_upload_image'); ?>

        </div>
        <form action="backend/handlers/create.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="job_company" type="text" id="simpleinput" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="job_address" type="text" id="simpleinput" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="password" type="password" id="simpleinput" class="form-control" minlength="8" required>
                                </div>
