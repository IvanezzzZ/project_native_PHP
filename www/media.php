...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="backend/handlers/media.php?id=<?= $edit_user_id ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?php if (!empty($edit_user['avatar'])) echo $edit_user['avatar']; else echo 'img/demo/avatars/default_avatar.png' ?>" alt="" class="img-responsive" width="200">
                                </div>
