                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <?php if (existFlashMessage('error_register')):?>
                                    <div class="alert alert-danger text-dark" role="alert">
                                        <strong>Уведомление! </strong><?= getFlashMessage('error_register') ?>
                                    </div>
                                    <?php endif; deleteFlashMessage('error_register'); ?>

                                    <form id="js-login" novalidate action="backend/handlers/register.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="password" type="password" id="password" class="form-control" placeholder="Пароль" minlength="8" required>
                                            <div class="invalid-feedback">Длина пароля должна быть не менее 8 символов</div>
                                        </div>
